document.addEventListener("DOMContentLoaded", function () {
    ...
    const rockNextButton = document.querySelector(".youWin1 .next");
    const paperNextButton = document.querySelector(".youWin2 .next");
    const scissorsNextButton = document.querySelector(".youWin3 .next");
